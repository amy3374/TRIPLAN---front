...
const MyPlanList = ({
  ...
  return (
    <div>
      <li className="flex items-center justify-between m-1 p-1 hover:scale-[1.005] ease-in duration-150 cursor-default w-full border-sky-100 border-b">
        <div className="flex justify-start items-center " onClick={goToMyPlan}>
          <p className="text-lg font-bold px-1 ">{des}</p>
